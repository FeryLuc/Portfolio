...
container.innerHTML = projects
  .map(
    (project) => `
  <article class="p-6 rounded-xl card bdr myShadowCard flex flex-col justify-between fade-section">
    ...
    <div class="tagsContainer flex gap-4 flex-wrap py-2 text-center">
      ${project.tags
        .map(
          (tag) => `
        <div class="bdr accent rounded-lg px-4 py-2 surface transition-all duration-300 ease-in-out">
          ${tag.tech}
          <div class="invisible">
            ${
              tag.demo
...
const projectArticles = document.querySelectorAll(
  "#projectsContainer article.fade-section"
);
